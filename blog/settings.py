...
SESION_COOKIE_AGE = int(os.getenv('DJANGO_SESION_COOKIE_AGE'))
SESION_COOKIE_HTTPONLY = bool(
    strtobool(os.getenv('DJANGO_SESION_COOKIE_HTTPONLY')))
SESION_COOKIE_SAMESITE = os.getenv('DJANGO_SESION_COOKIE_SAMESITE')
SESION_COOKIE_SECURE = bool(
    strtobool(os.getenv('DJANGO_SESION_COOKIE_SECURE')))
